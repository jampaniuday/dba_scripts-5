# +-------------------------------------------------------------------+
# | FILE          : create_ORA734_datebase.sql                        |
...
spool  create_ORA734_database.log

!rm $ORACLE_HOME/dbs/orapwORA734
!$ORACLE_HOME/bin/orapwd file=$ORACLE_HOME/dbs/orapwORA734 password=change_on_install entries=50
...
CREATE DATABASE "ORA734" NOARCHIVELOG
    MAXLOGFILES    32
    MAXLOGMEMBERS  5
    MAXDATAFILES   600
    MAXINSTANCES   10
...
LOGFILE
  GROUP 1
 ('/u03/app/oradata/ORA734/redo_g01a.log',
  '/u04/app/oradata/ORA734/redo_g01b.log',
  '/u05/app/oradata/ORA734/redo_g01c.log') SIZE 5M,
  GROUP 2 
( '/u03/app/oradata/ORA734/redo_g02a.log',
  '/u04/app/oradata/ORA734/redo_g02b.log',
  '/u05/app/oradata/ORA734/redo_g02c.log') SIZE 5M,
  GROUP 3 
( '/u03/app/oradata/ORA734/redo_g03a.log',
  '/u04/app/oradata/ORA734/redo_g03b.log',
  '/u05/app/oradata/ORA734/redo_g03c.log') SIZE 5M
DATAFILE
  '/u08/app/oradata/ORA734/system01.dbf' size 300M;
/
...
@$ORACLE_HOME/rdbms/admin/prvtpool.sql
...
CREATE TABLESPACE rbs1 
  DATAFILE '/u06/app/oradata/ORA734/rbs1_01.dbf' size 100M;

CREATE TABLESPACE rbs2 
  DATAFILE '/u06/app/oradata/ORA734/rbs2_01.dbf' size 100M;
...
CREATE TABLESPACE temp
  DATAFILE '/u07/app/oradata/ORA734/temp01.dbf' SIZE 500M
  DEFAULT STORAGE (
    MINEXTENTS   1
    MAXEXTENTS   500
    INITIAL      1M
