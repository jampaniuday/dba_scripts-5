 ...
 * LinkedListItr   find( x )          --> Return position that views x
 * LinkedListItr   findPrevious( x )  --> Return position prior to x
 * 
 * +++++++++++++++++++++++++++++    ERRORS     +++++++++++++++++++++++++++++++++
 * No special errors
 *
 ...
 * Construct the list with no initializer. Access is via LinkedListItr class
 * -----------------------------------------------------------------------------
...
public class LinkedList {
    ...
    /**
     * Construct the list with no initializer
     */
    public LinkedList() {
