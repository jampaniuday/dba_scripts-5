 ...
 * The following code block will generate random numbers from 0 to 256. Also 
...
public class RandomNumberBounds2 {
    ...
    private static void doRawRandomNumber2() {

        int rawRandomNumber;

        for (int i = 0; i < 500; i++) {
            rawRandomNumber = getRandom(256);
