 ...
 * file provided on the command line. This example uses the Crimson XML parser.
 *
 * COMPILE:
 * --------------------------
 * javac CrimsonXmlDomExample.java
 *
 * 
 * RUN PROGRAM:
 * --------------------------
 * java CrimsonXmlDomExample DatabaseInventory.xml
 * 
 * -----------------------------------------------------------------------------
 * @version 1.0
...
public class CrimsonXmlDomExample {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            System.err.println("\nUsage: java CrimsonXmlDomExample filename\n");
            System.exit(1);
        }
