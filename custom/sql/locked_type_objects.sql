/* Formatted on 05/06/15 11:46:09 a.m. (QP5 v5.256.13226.35538) Moficado por Abner Aguilar <abner.aguilar@telefonica.com> - Fecha - OT - */
-- -----------------------------------------------------------------------------------
...
COLUMN locked_mode FORMAT A15
  ...
  SELECT lo.session_id AS sid,
    ...
    WHERE o.object_name = DECODE(UPPER('&objeto'), '', o.object_name, UPPER('&objeto'))
ORDER BY 1,
         2,
         3,
         4;
